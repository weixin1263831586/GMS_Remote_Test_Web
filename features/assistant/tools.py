...
_CATEGORY_KEYWORDS: dict[str, list[str]] = {
    ...
    "automation": ["ATS", "GMS ATS", "自动化流水线", "自动化任务", "automation"],
    "cluster": ["集群", "cluster", "Worker", "集群任务", "主机集群"],
    "build": ["构建", "build", "编译任务", "构建任务"],
    "knowledge": ["知识库", "Wiki", "文档", "知识问答", "knowledge"],
}
...
_EXECUTOR_REF_OVERRIDES: dict[str, str] = {
    ...
    "/api/devices/remount": "features.devices.operations_api:remount_devices",
    "/api/devices/wifi": "features.devices.api:connect_wifi",
    "/api/devices/shell": "features.devices.operations_api:open_device_shell",
    ...
    "/api/burn/gsi": "features.firmware.gsi_sn_burn:burn_gsi",
    "/api/burn/serial": "features.firmware.gsi_sn_burn:burn_sn",
    ...
    "/api/apk/tasks": "features.firmware.apk_api:list_apk_tasks",
    # --- 补充：测试套件 ---
...
def _register_extra_tools(registry: ToolRegistry) -> None:
    ...
    extras = [
        ...
        AgentTool(
            ...
            category="automation",
            description="查看 GMS ATS 流水线总览",
            api_path="/api/automation/dashboard",
            method="GET",
            params=[],
            keywords=_kw("automation", "ATS状态", "ATS总览", "流水线状态"),
            is_readonly=True,
            is_dangerous=False,
            requires_confirm=False,
            executor_ref="features.automation.api:automation_dashboard",
            response_type="status",
        ),
        AgentTool(
            name="automation_runs",
            category="automation",
            description="查询 GMS ATS 运行记录",
            api_path="/api/automation/runs",
            method="GET",
            params=[
                {"name": "status", "type": "string", "required": False, "desc": "运行状态"},
                {"name": "limit", "type": "integer", "required": False, "desc": "返回数量"},
            ],
            keywords=_kw("automation", "ATS任务", "ATS运行记录", "自动化记录"),
            is_readonly=True,
            is_dangerous=False,
            requires_confirm=False,
            executor_ref="features.automation.api:list_automation_runs",
            response_type="list",
        ),
        AgentTool(
            name="automation_run_cancel",
            category="automation",
            description="取消指定 GMS ATS 运行",
            api_path="/api/automation/runs/{run_id}/cancel",
            method="POST",
            params=[{"name": "run_id", "type": "string", "required": True, "desc": "ATS Run ID"}],
            keywords=_kw("automation", "取消ATS", "停止ATS", "取消自动化任务"),
            is_readonly=False,
            is_dangerous=False,
            requires_confirm=True,
            executor_ref="features.automation.api:cancel_automation_run",
            response_type="status",
        ),
        AgentTool(
            name="automation_run_retry",
            category="automation",
            description="重试指定的终态 GMS ATS 运行",
            api_path="/api/automation/runs/{run_id}/retry",
            method="POST",
            params=[{"name": "run_id", "type": "string", "required": True, "desc": "ATS Run ID"}],
            keywords=_kw("automation", "重试ATS", "ATS重跑", "重试自动化任务"),
            is_readonly=False,
            is_dangerous=False,
            requires_confirm=True,
            executor_ref="features.automation.api:retry_automation_run",
            response_type="status",
        ),
        AgentTool(
            name="cluster_status",
            category="cluster",
            description="查看主机集群运行模式和 Worker 数量",
            api_path="/api/cluster/status",
            method="GET",
            params=[],
            keywords=_kw("cluster", "集群状态", "cluster status", "Worker状态"),
            is_readonly=True,
            is_dangerous=False,
            requires_confirm=False,
            executor_ref="features.cluster.api:cluster_status",
            response_type="status",
        ),
        AgentTool(
            name="cluster_workers",
            category="cluster",
            description="查询集群 Worker 主机",
            api_path="/api/cluster/workers",
            method="GET",
            params=[],
            keywords=_kw("cluster", "Worker列表", "集群主机", "主机列表"),
            is_readonly=True,
            is_dangerous=False,
            requires_confirm=False,
            executor_ref="features.cluster.api:list_workers",
            response_type="list",
        ),
        AgentTool(
            name="cluster_devices",
            category="cluster",
            description="查询集群设备池",
            api_path="/api/cluster/devices",
            method="GET",
            params=[{"name": "worker_id", "type": "string", "required": False, "desc": "Worker ID"}],
            keywords=_kw("cluster", "集群设备", "设备池", "Worker设备"),
            is_readonly=True,
            is_dangerous=False,
            requires_confirm=False,
        ...
        AgentTool(
            name="cluster_jobs",
            category="cluster",
            description="查询持久化 Cluster Job",
            api_path="/api/cluster/jobs",
            method="GET",
            params=[{"name": "limit", "type": "integer", "required": False, "desc": "返回数量"}],
            keywords=_kw("cluster", "集群任务", "Cluster Job", "持久化任务"),
            is_readonly=True,
            is_dangerous=False,
            requires_confirm=False,
            executor_ref="features.cluster.jobs_api:list_jobs",
            response_type="list",
        ),
        AgentTool(
            name="cluster_job_cancel",
            category="cluster",
            description="停止指定 Cluster Job",
            api_path="/api/cluster/jobs/{job_id}/cancel",
            method="POST",
            params=[{"name": "job_id", "type": "string", "required": True, "desc": "Cluster Job ID"}],
            keywords=_kw("cluster", "停止集群任务", "取消Cluster Job", "停止Worker任务"),
            is_readonly=False,
            is_dangerous=False,
            requires_confirm=True,
        ...
        AgentTool(
            name="build_jobs",
            category="build",
            description="查询固件构建任务",
            api_path="/api/build/jobs",
            method="GET",
            params=[
                {"name": "status", "type": "string", "required": False, "desc": "构建状态"},
                {"name": "limit", "type": "integer", "required": False, "desc": "返回数量"},
            ],
            keywords=_kw("build", "构建任务", "编译状态", "build jobs"),
            is_readonly=True,
            is_dangerous=False,
            requires_confirm=False,
