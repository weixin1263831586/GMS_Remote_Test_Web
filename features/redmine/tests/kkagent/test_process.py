...
def _write_fake_kkagent(directory: Path, behavior: str) -> Path:
    ...
    helper = (
        ...
        "    _tool(stream, prefix + '1', 'gms_rt_redmine_issue_fetch', "
        "json.dumps({'issue_id': 1, 'snapshot_id': 'snap-1'}), {'issue': 1})\n"
        ...
        "    _tool(stream, 'c1', 'gms_rt_redmine_issue_fetch', json.dumps(env), {'issue': 1})\n"
        "    _tool(stream, 'c2', 'gms_rt_redmine_journals', 'journals', {'issue': 1})\n"
