...
| `gms-rt-knowledge-search` | Search background Android system-mechanism knowledge from the external wiki (read-only, ADR 0014) | gms-rt-knowledge-search QUERY [--limit N] [--android-api-level N] |
