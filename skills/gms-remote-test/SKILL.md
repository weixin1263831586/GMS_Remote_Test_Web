...
| 变量名 | 说明 | 默认值 |
|--------|------|--------|
| `GMS_REMOTE_TEST_SERVER` | 服务器地址 | `https://localhost:5001` (自动检测) |
...
**Web Interface**: https://localhost:5001 (或 $GMS_REMOTE_TEST_SERVER)
**API Docs**: https://localhost:5001/docs (或 $GMS_REMOTE_TEST_SERVER/docs)
